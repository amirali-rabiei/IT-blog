<template>
    <div class="mt-[176px]">
        <div id="services" class="text-center w-full">
            ...
            <p class=" text-[18px] leading-relaxed text-gray-600">Our company focuses on cutting-edge technologies in
                Artificial
        ...
        <div
            ...
            <div class="w-full lg:w-[476px]">
                <img class="w-full h-auto md:h-[267px] object-cover rounded-t-[27px]"
                    ...
                    alt="">
                <div
                    class=" bg-[white] leading-relaxed p-[15px] w-full lg:w-[476px] md:w-[476px] flex flex-col gap-y-[15px] pt-[35px]">
            ...
            <div class="w-full lg:w-[476px]">
                <img class="w-full h-auto md:h-[267px] object-cover rounded-t-[27px]"
                    ...
                    alt="">
                <div
                    class=" bg-[white] leading-relaxed p-[15px] w-full lg:w-[476px] flex flex-col gap-y-[15px] pt-[35px]">

<template>
    <div class="mt-[176px]">
        <div id="services" class="text-center w-full">
            <!-- <p class="font-[Bnim] text-[44px] uppercase">Lorem Ipsum is simply</p> -->
            <p class="font-[Bnim] text-[28px] md:text-[78px] uppercase">Our Activites</p>
            <p class=" text-[18px] leading-relaxed text-gray-600">Our company focuses on cutting-edge technologies in Artificial
                Intelligence, Internet of Things, and Augmented Reality, delivering innovative solutions across these
                fields.</p>
        </div>
        ...
        <div
            class="grid grid-cols-1 md:grid-cols-2 w-fit mx-auto lg:grid-cols-2  gap-y-[90px] gap-15 justify-items-center mt-[120px]">
            <div class="w-full lg:w-[476px]">
                <img class="w-[476px] h-auto md:h-[267px] object-cover rounded-t-[27px]"
                    ...
                    alt="">
                <div class=" bg-[white] leading-relaxed p-[15px] w-full lg:w-[476px] md:w-[476px] flex flex-col gap-y-[15px] pt-[35px]">
                    <h1 class="text-[22px] md:text-[30px] font-bold">AI Solutions</h1>
                    <p class="text-[18px] md:text-[20px] text-gray-600">Empowering businesses with intelligent
            ...
            <div class="w-full lg:w-[476px]">
                <img class="w-[476px] h-auto md:h-[267px] object-cover rounded-t-[27px]"
                    ...
                    alt="">
                <div class=" bg-[white] leading-relaxed p-[15px] w-full lg:w-[476px] flex flex-col gap-y-[15px] pt-[35px]">

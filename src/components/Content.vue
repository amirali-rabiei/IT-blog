<template>
    <div class="mt-[176px]">
        <div id="services" class="text-center w-full">
            ...
            <p class="font-[Bnim] lg:text-[88px] text-[40px] uppercase">Our Products</p>
            <p class="font-[nim] text-[18px]">Our products combine cutting-edge technologies in Artificial Intelligence,
                Internet of Things, and Augmented Reality to enhance smart processes and user experiences.</p>
        </div>




        <div class="grid grid-cols-1 lg:grid-cols-2  gap-y-[100px] gap-10 justify-items-center mt-[120px]">
            <div class="w-full md:w-[476px]">
                <img class="w-[476px] rounded-t-[27px]"
                ...
                <div class=" bg-[white] p-[15px] w-full lg:w-[476px] md:w-[476px] flex flex-col gap-y-[15px] pt-[35px]">
                    <h1 class="text-[30px] font-bold">AI Solutions</h1>
                    <p class="text-[22px]">Empowering businesses with intelligent automation and data-driven insights.
                    </p>
            ...
            <div class="w-full md:w-[476px]">
                <img class="w-[476px] h-[267px] rounded-t-[27px]"
                ...
                <div class=" bg-[white] p-[15px] w-full lg:w-[476px] flex flex-col gap-y-[15px] pt-[35px]">
                    <h1 class="text-[30px] font-bold">IoT Devices</h1>
                    <p class="text-[22px]">
            ...
            <div class="w-full md:w-[476px]">
                <img class="w-[476px] h-[267px] rounded-t-[27px]"
                    ...
                    alt="">
                <div class=" bg-[white] p-[15px] w-full lg:w-[476px] flex flex-col gap-y-[15px] pt-[35px]">
                    <h1 class="text-[30px] font-bold">AR & VR</h1>
                    <p class="text-[22px]">
            ...
            <div class="w-full md:w-[476px]">
                <img class="w-[476px] h-[267px] rounded-t-[27px]"
                    ...
                    alt="">
                <div class=" bg-[white] p-[15px] w-full lg:w-[476px] flex flex-col gap-y-[15px] pt-[35px]">
                    <h1 class="text-[30px] font-bold">Analytics & Cloud</h1>
                    <p class="text-[22px]">

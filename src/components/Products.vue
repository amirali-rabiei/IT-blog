<template>
    <div class="mt-[176px]">
        <div id="services" class="text-center w-full">
            ...
            <p class="font-[Bnim] text-[28px] md:text-[78px] uppercase">{{ $t('products.title') }}</p>
            <p class=" text-[18px] text-gray-600">{{ $t('products.description') }}</p>
        </div>




        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  mx-auto w-fit gap-4 justify-center mt-[120px]">
            <div class="w-full lg:w-[100%]">
                <img class="w-[400px] h-auto md:h-[267px] rounded-t-[27px]"
                    ...
                    alt="">
                <div class=" bg-[white] p-[15px] w-full lg:w-[400px] md:w-[476px] flex flex-col gap-y-[15px] pt-[35px]">

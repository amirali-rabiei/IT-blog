...
async function getBlog() {
    ...
    try {
        const response = await api.get(`https://py-64mn.onrender.com/blog/${id}`, {
    ...
    <div>
        ...
        <div v-else-if="loading">
            <div
                ...
                <p class="text-[#3B3C4A]  text-[19px] md:text-[21px] break-words leading-relaxed" v-html="content"></p>
            </div>
        </div>
